...
| EBITDA Normalization | **Complete** | $10.56M TTI standalone / $10.81M TTI+T-K consolidated (39 mo). $2.75M raw / $2.56M after $191K bad debt normalization for 2025 vs broker $2.52M consolidated. T-K consolidation bridge: intercompany wash ($3.86M), T-K operating expenses baseline, T-K add-backs ($243K). Normalized bad debt (per NWC reserve): $339K total ($60K/$88K/$191K by year). |
...
| May 30 | Normalized bad debt (per NWC reserve): $339K total ($60K/$88K/$191K by year). Adjusted EBITDA revised to $10.56M TTI standalone | EBITDA_Normalization.html, Revenue_AR_TTI.html |
