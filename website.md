...
| EBITDA Normalization | **Complete** | $11.00M TTI standalone / $11.25M TTI+T-K consolidated (39 mo). $2.75M pre-rent-adjustment / $2.61M after all adjustments for 2025 vs broker $2.52M consolidated (3.5% above broker). T-K consolidation bridge: intercompany wash ($3.86M), T-K operating expenses baseline, T-K add-backs ($243K). Disguised owner tax payments: $417K total ($370K 2023 + $47K 2024). Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary: $372K total ($114K/year). Employer payroll taxes (Kevin & Tami): $42K total ($13K/year). Michael J. Johnson confirmed as actual GM ($161K in 2025) — no replacement cost. |
...
| May 30 | Disguised owner tax payments corrected: $417K total ($370K 2023 + $47K 2024). Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary: $372K total ($114K/year). Employer payroll taxes (Kevin & Tami): $42K total ($13K/year). Michael J. Johnson confirmed as actual GM ($161K in 2025). GM salary replacement removed. Adjusted EBITDA revised to $11.00M TTI standalone | EBITDA_Normalization.html, Revenue_AR_TTI.html |
