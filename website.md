...
| EBITDA Normalization | **Complete** | $10.35M TTI standalone / $10.59M TTI+T-K consolidated (39 mo). $2.75M pre-rent-adjustment / $2.51M after all adjustments for 2025 vs broker $2.52M consolidated (0.4% delta, immaterial). T-K consolidation bridge: intercompany wash ($3.86M), T-K operating expenses baseline, T-K add-backs ($243K). Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary: $372K total ($114K/year). |
...
| May 30 | Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary add-back: $372K total ($114K/year). Adjusted EBITDA revised to $10.35M TTI standalone | EBITDA_Normalization.html, Revenue_AR_TTI.html |
