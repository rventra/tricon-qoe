...
| EBITDA Normalization | **Complete** | $9.98M TTI standalone / $10.22M TTI+T-K consolidated (39 mo). $2.75M pre-rent-adjustment / $2.40M after all adjustments for 2025 vs broker $2.52M consolidated. T-K consolidation bridge: intercompany wash ($3.86M), T-K operating expenses baseline, T-K add-backs ($243K). Normalized bad debt: $339K total. TTIO missing rent: $585K total ($351K 2025 + $234K Q1 2026). |
...
| May 30 | Normalized bad debt: $339K total. TTIO missing rent: $585K total ($351K 2025 + $234K Q1 2026). Adjusted EBITDA revised to $9.98M TTI standalone | EBITDA_Normalization.html, Revenue_AR_TTI.html |
