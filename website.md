...
| EBITDA Normalization | **Complete** | $10.77M TTI standalone / $11.03M TTI+T-K consolidated / $8.88M total group (incl. TWS drag est.) (39 mo). $2.75M pre-rent-adjustment / $2.61M after all adjustments for 2025 vs broker $2.52M consolidated (3.5% above broker). T-K standalone bridge: Revenue $3.88M (IC subcontractor), Expenses $3.86M, Net Income $22.7K, Interest +$27.9K, Anaheim +$208K = T-K Adj EBITDA $258.8K. TWS drag: $2.925M est. ($900K/year*; Kevin H 2023 tax return: $885K revenue, $933K cash burn, ($48K) net loss). Disguised owner tax (net): $181K total (+$370K 2023 / -$189K 2024). Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary: $372K total ($114K/year). Employer payroll taxes (Kevin & Tami): $42K total ($13K/year). Michael J. Johnson confirmed as actual GM ($161K in 2025) — no replacement cost. |
