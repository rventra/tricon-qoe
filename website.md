...
| EBITDA Normalization | **Complete** | $10.78M TTI standalone / $11.03M TTI+T-K consolidated / $8.88M total group (incl. TWS drag est.) (39 mo). 2025: TTI standalone $2.61M vs broker $2.52M consolidated (3.5% above broker). Pre-TTIO rent: $2.96M. TWS drag ($900K/year) sits outside TTI P&L — found on Kevin Harshberger's 2023 tax return, not in TTI GL. TWS cash transfers ($1.5M total) added back to TTI standalone as intercompany funding. T-K standalone bridge: Revenue $3.88M (IC subcontractor), Expenses $3.86M, Net Income $22.7K, Interest +$27.9K, Anaheim +$208K = T-K Adj EBITDA $258.8K. Disguised owner tax (net): $181K total (+$370K 2023 / -$189K 2024). Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary: $372K total ($114K/year). Employer payroll taxes (Kevin & Tami): $42K total ($13K/year). Charitable contributions: $14K total. Michael J. Johnson confirmed as actual GM ($161K in 2025) — no replacement cost. |
