...
| EBITDA Normalization | **Complete** | $10.63M TTI standalone / $10.87M TTI+T-K consolidated (39 mo). $2.75M pre-rent-adjustment / $2.60M after all adjustments for 2025 vs broker $2.52M consolidated (3.0% above broker). T-K consolidation bridge: intercompany wash ($3.86M), T-K operating expenses baseline, T-K add-backs ($243K). Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary: $372K total ($114K/year). Michael J. Johnson confirmed as actual GM ($161K in 2025) — no replacement cost. |
...
| May 30 | Normalized bad debt: $339K total. TTIO missing rent: $585K total. Kevin Harshberger owner salary add-back: $372K total ($114K/year). Michael J. Johnson confirmed as actual GM ($161K in 2025). GM salary replacement removed. Adjusted EBITDA revised to $10.63M TTI standalone | EBITDA_Normalization.html, Revenue_AR_TTI.html |
